...
The `nested_data_test_suite` data source is designed for testing and validating complex nested data structures within Terraform providers. It processes nested objects, maps, and lists to ensure proper CTY (Cloud Terraform YAML) data type handling and serialization.
...
data "pyvider_simple_map_test" "test" {
  input_data = {
    level1 = {
      level2 = {
        values = ["a", "b", "c"]
...
output "processed_data" {
  value = data.pyvider_simple_map_test.test.test_data
}
```
