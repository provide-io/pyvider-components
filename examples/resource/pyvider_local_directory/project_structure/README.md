# Resource: pyvider_local_directory - project_structure Example

This directory contains a complete, executable Terraform example demonstrating the `pyvider_local_directory` resource.
