...
# Ensure this module is accessible as 'tests.memray.conftest' so that
# test files importing from that path share the same _baseline_updates dict.
if "tests.memray.conftest" not in sys.modules:
    sys.modules["tests.memray.conftest"] = sys.modules[__name__]
